...
class ENet(nn.Module):
    def __init__(self, input_ch, output_ch):
        ...
        self.bottleNeck1_1 = RegularBottleNeck(input_ch=64, output_ch=64, regularizer_prob=0.01, kernel_size=31)
        self.bottleNeck1_2 = RegularBottleNeck(input_ch=64, output_ch=64, regularizer_prob=0.01, kernel_size=21)
        self.bottleNeck1_3 = RegularBottleNeck(input_ch=64, output_ch=64, regularizer_prob=0.01, kernel_size=17)
        self.bottleNeck1_4 = RegularBottleNeck(input_ch=64, output_ch=64, regularizer_prob=0.01, kernel_size=11)
